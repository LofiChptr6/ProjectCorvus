...
PERSONALITY = {
    ...
    "energy": ("Energy", "Oil & gas / refiners / services / midstream",
              "Supply-driven. Energy trades on inventory builds/draws, OPEC discipline, refining cracks, and midstream throughput. XOM/CVX are the integrated bellwethers; XLE the sector ETF; DUG the bearish vehicle. Sibling of Commodity — you own hydrocarbons."),
    "commodity": ("Commodity", "Metals + materials + chemicals",
              "Cycle-aware. Real rates drive gold (GLD/NEM/GOLD), China demand drives base metals (FCX/SCCO/RIO/BHP), industrial gases (LIN/APD) are defensive growth. Sibling of Energy — you own everything resource-related ex-hydrocarbons."),
...
def main():
    ...
    bootstrap_models = {
        ...
        "energy": "breakout_strength",
        "commodity": "breakout_strength",
