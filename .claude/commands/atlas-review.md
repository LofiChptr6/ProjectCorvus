...
2. For each non-flat call: `submit_conviction_view(agent_name="atlas", symbol, direction, conviction, expected_return_pct, time_to_target_days, rationale, expires_in_hours, model_inputs?)`.
