...
- Header agent tag: `🛰 *atlas* · ...`
- Model dir for the optional Code-adjustment block (if you Edited a model this run): `agents/atlas/models/*.py`
